...
export const PROGRAMS: Program[] = [
  ...
  },
  {
    ...
    short: 'Cursive, Print & Lucida styles for neat academic writing.',
    category: 'handwriting',
    ...
    benefits: ['Legible handwriting', 'Better notebook presentation', 'Improved writing speed', 'Better focus', 'Confident schoolwork', 'Strong academic advantage'],
  },
  {
