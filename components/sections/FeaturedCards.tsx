...
function CalligraphyModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const services = [
    { title: 'Wedding Invitations', desc: 'Elegant hand-lettered invitation cards styled to match your wedding theme, making a lasting first impression on every guest.' },
    { title: 'Award Certificates', desc: 'Beautifully lettered certificates for schools, organisations, and events — crafted to honour achievement with elegance and care.' },
    { title: 'Birthday and Anniversary Cards', desc: 'Personalised handwritten cards that carry warmth and artistry for every birthday and anniversary celebration.' },
    { title: 'Thank-You Notes', desc: 'Thoughtfully lettered thank-you notes that add a premium, personal touch to any gesture of gratitude.' },
    { title: 'Guest Name Cards', desc: 'Elegant hand-lettered name cards that bring a refined, personal welcome to every seat at your event.' },
    { title: 'Motivational Quotes', desc: 'Inspirational quotes and meaningful words lettered beautifully for display, gifting, or daily motivation.' },
    { title: 'Custom Gifts', desc: 'Names, monograms, and heartfelt messages lettered on frames, cards, and keepsakes — perfect for any occasion.' },
    { title: 'Event Displays', desc: 'Hand-lettered welcome boards, seating charts, and signage that elevate weddings, parties, and corporate events.' },
  ]
        ...
        >
          ...
          >
            ...
            <p className="px-7 pt-3 italic text-[13px]" style={{ color: '#4A5980' }}>
              Make your words look beautiful with our elegant calligraphy services.
            </p>
            <p className="px-7 pt-2 text-[13.5px] leading-[1.75]" style={{ color: '#4A5980' }}>
              We provide stylish and neat handwritten calligraphy for invitation cards, certificates, greeting cards, envelopes, name cards, gift notes, wall frames, school projects, event boards, menu cards, and special messages. Our calligraphy adds a premium, artistic, and personal touch to every occasion.
            </p>

            {/* All 6 services */}
            <div className="px-7 pt-5">
              <p className="text-[10px] font-bold uppercase tracking-widest mb-4" style={{ color: accent }}>Perfect For Every Occasion</p>
              <div className="flex flex-col gap-3">
                {services.map((s, i) => (
...
function CalligraphyServiceCard({ onLearnMore }: { onLearnMore: () => void }) {
  return (
    ...
    >
      ...
      {/* Description — same style as handwriting cards */}
      <div className="px-6 py-4">
        <p className="text-[13.5px] leading-relaxed" style={{ color: '#4A5980' }}>
          We provide stylish and neat handwritten calligraphy for invitation cards, certificates, greeting cards,
          envelopes, name cards, gift notes, wall frames, school projects, event boards, menu cards, and special
          messages. Our calligraphy adds a premium, artistic, and personal touch to every occasion.
        </p>
      </div>
...
function LegibleNeatCard({ onLearnMore }: { onLearnMore: () => void }) {
  return (
    ...
    >
      ...
      <div className="px-6 py-4">
        <p className="text-[13.5px] leading-relaxed" style={{ color: '#4A5980' }}>
           Our Legible & Neat Handwriting Program is specially designed for school children to improve their handwriting in three important styles: Cursive, Print, and Luc......
        </p>
      </div>
...
export default function FeaturedCards() {
  ...
  const legibleNeatProgram = PROGRAMS.find(p => p.slug === 'legible-neat')!
    ...
    <section className="scroll-mt-20">
      ...
      <div id="handwriting" className="py-16 px-6 lg:px-10 bg-paper scroll-mt-20">
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 max-w-6xl mx-auto">
          ...
          <LegibleNeatCard onLearnMore={() => setActive(legibleNeatProgram)} />
